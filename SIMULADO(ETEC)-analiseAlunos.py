...
## VARIÁVEIS
documentName = 'Simulado ETEC - 28/04 - Uds'
...
subjects = [
    TestSubject('Português', 12, 12),
    TestSubject('Matemática', 12, 24),
    TestSubject('História', 7, 31),
    TestSubject('Geografia', 7, 38),
    TestSubject('Química', 4, 42),
    TestSubject('Física', 3, 46),
    TestSubject('Biologia', 4, 50),
]
